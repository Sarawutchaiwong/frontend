...
<div className="card shadow-sm">    
  <img className="rounded img-responsive" src="/images/roblox.png" alt="..." />
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <img className="rounded img-responsive" src="/images/roblox2.png" alt="..." />
  <div className="card-body">
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <img className="rounded img-responsive" src="/images/roblox3.png" alt="..." />
  <div className="card-body">
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <img className="rounded img-responsive" src="/images/roblox4.png" alt="..." />
  <div className="card-body">
