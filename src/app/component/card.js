...
<div className="card shadow-sm">    
  <Image className="rounded img-responsive" src="/images/roblox.png" alt="..." width={200} height={200} />
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <Image className="rounded img-responsive" src="/images/roblox2.png" alt="..." width={200} height={200}/>
  <div className="card-body">
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <Image className="rounded img-responsive" src="/images/roblox3.png" alt="..." width={200} height={200}/>
  <div className="card-body">
...
<div className="col-md-2 mb-4">
<div className="card shadow-sm">    
  <Image className="rounded img-responsive" src="/images/roblox4.png" alt="..." width={200} height={200}/>
  <div className="card-body">
